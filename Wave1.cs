...
public class Wave1 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _player.GetComponent<Player>().SetWaveNumber(1);
        StartCoroutine(TimerRoutine());
        GameObject.FindGameObjectWithTag("Canvas").transform.GetChild(5).gameObject.transform.GetChild(0).gameObject.GetComponent<PlayerWeaponControl>().SetDamageVal(0.8f);
    }
