...
public class Wave4 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _player.GetComponent<Player>().SetWaveNumber(4);
        StartCoroutine(TimerRoutine());
        GameObject.FindGameObjectWithTag("Canvas").transform.GetChild(5).gameObject.transform.GetChild(0).gameObject.GetComponent<PlayerWeaponControl>().SetDamageVal(2f);
    }
